            ...
            <div class="settings-body">
                ...
                <div class="settings-group">
                    ...
                    <label>
                        ...
                        <input type="checkbox" id="set-show-labels" ${state.viewerSettings.showLabels ? 'checked' : ''}>
                    </label>
                    <label>
                        <span>Label Mode</span>
                        <select id="set-label-mode">
...
function _bindEvents(container) {
    ...
    bindCheckbox('#set-show-labels', 'showLabels');
    bindSelect('#set-label-mode', 'labelMode');
    ...
    container.querySelector('#btn-reset-settings')?.addEventListener('click', () => {
        ...
        state.viewerSettings.themePreset = 'IsoTheme';
